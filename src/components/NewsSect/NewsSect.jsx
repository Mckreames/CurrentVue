...
export default function NewsSect() {
  return (
    <section className="background-color">
        ...
        <div className="container-fluid row mt-4 pb-5 d-flex flex-column flex-md-row justify-content-center">
            <div className="story story1 h-100 col col-md-3 offset-1 text-center">
            ...
            <div className="story story2 h-100 col col-md-4 text-center">
            ...
            <div className="story story3 h-100 col col-md-3 text-center">
