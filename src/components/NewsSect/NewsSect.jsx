...
export default function NewsSect() {
  return (
    <section className="background-color">
        ...
        <div className="container-fluid row mt-4 pb-5 d-flex flex-column flex-lg-row justify-content-center">
            <div className="story story1 h-100 mx-auto col col-md-8 col-lg-3 offset-1 text-center">
            ...
            <div className="story story2 h-100 mx-auto col col-md-8 col-lg-4 text-center">
            ...
            <div className="story story3 h-100 mx-auto col col-md-8 col-lg-3 text-center">
